...
public class ZHConverterUtils {
	...
	static {
		propertyFiles[ConverterType.TRADITIONAL.ordinal()] = "/prop/zh2Hant.properties";
		propertyFiles[ConverterType.SIMPLIFIED.ordinal()] = "/prop/zh2Hans.properties";
	}
	...
	public static void main(String[] args) {
		System.out.println(ZHConverterUtils.convert("饭", ZHConverterUtils.ConverterType.TRADITIONAL));
		System.out.println(ZHConverterUtils.convert("飯", ZHConverterUtils.ConverterType.SIMPLIFIED));
	}
