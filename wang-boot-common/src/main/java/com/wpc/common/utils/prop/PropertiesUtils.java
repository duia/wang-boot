package com.wpc.common.utils.prop;
...
public class PropertiesUtils {
	...
	public static String getProperty(String filePath, String name) {
		if (StringUtils.isEmpty(filePath) || StringUtils.isEmpty(name)) {
	...
	public static void main(String[] args) {
		System.out.println(PropertiesUtils.getProperty("/config/jdbc.properties", "url"));
	}
