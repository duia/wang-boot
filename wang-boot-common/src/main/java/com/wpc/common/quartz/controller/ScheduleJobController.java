package com.wpc.common.quartz.controller;
...
public class ScheduleJobController {
    ...
    public String inputScheduleJob(ScheduleJobVo scheduleJobVo, String keywords, ModelMap modelMap) {
    ...
    public String saveScheduleJob(ScheduleJobVo scheduleJobVo, String keywords) {
...
//        scheduleJobVo.setStatus("1");
        ...
        } else if (StringUtils.equalsIgnoreCase(keywords, "delUpdate")){
