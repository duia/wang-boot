package com.wpc.common.mongo.aop;

import com.wpc.common.mongo.aop.handler.DecisionHandler;
import com.wpc.common.mongo.config.holder.MongodbTemplateContextHolder;
import com.wpc.common.mongo.dao.multimongo.MultiMongo;
...
public class DBDecisionDaoAop implements ApplicationContextAware {
     ...
     * @throws Throwable
     */
    @Around("@annotation(com.wpc.common.mongo.dao.multimongo.MultiMongo)")
