...
Code.generate = function () {
    ...
    var baseAjax = WPC.baseAjax("/code/generate", "生成代码");
...
Code.setTableName = function (tableName) {
    ...
    $("#className").val(WPC.underLineToCamel(tableName.substring(preSize)));
};
...
Code.showMenuSelectTree = function () {
    WPC.showInputTree("parentMenuName", "pcodeTreeDiv", 15, 34);
};
