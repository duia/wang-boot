...
import com.wpc.sys.service.OfficeService;
import com.wpc.sys.utils.DictUtils;
...
//        model.addAttribute("list", officeService.findAll());
	...
	public String save(Office office, Model model, RedirectAttributes redirectAttributes) {
		...
		Long id = new Long(0).equals(office.getParentId()) ? null : office.getParentId();
